  ...
  return (
    <main>
        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white/80">
              We&apos;re on a mission to make the world&apos;s trending products accessible to
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="font-heading text-3xl font-extrabold text-[#1B2A5E]">{stat.value}</p>
      ...
      <section className="py-16 bg-[var(--color-surface)]">
        <Container narrow>
          <h2 className="font-heading text-3xl font-bold text-[#1B2A5E] mb-6">Our Story</h2>
      ...
      <section className="py-16 bg-white">
        <Container>
          <h2 className="font-heading text-3xl font-bold text-[#1B2A5E] text-center mb-12">
            What We Stand For
          </h2>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {VALUES.map((value) => (
              ...
              >
                ...
                <h3 className="font-heading text-base font-bold text-[#1B2A5E]">{value.title}</h3>
      ...
      <section className="py-16 bg-[var(--color-secondary)]">
        <Container>
          <div className="text-center">
            <h2 className="font-heading text-2xl font-bold text-[#1B2A5E] sm:text-3xl">
