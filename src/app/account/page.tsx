        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-sm text-[var(--color-text-primary)]">Order History</p>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-sm text-[var(--color-text-primary)]">Continue Shopping</p>
