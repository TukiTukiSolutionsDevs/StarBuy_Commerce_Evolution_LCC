...
export const createProductTool = tool({
  ...
  inputSchema: zodSchema(z.object({
    ...
    tags: z
      .array(z.string())
      .optional()
      .describe('Array of tags for the product'),
    status: z
...
export const cancelOrderTool = tool({
  ...
  inputSchema: zodSchema(z.object({
    ...
    restock: z
      ...
      .optional()
      .default(true)
      .describe('Whether to restock the items'),
    refund: z
      .boolean()
      .optional()
      .default(false)
...
export const createFulfillmentTool = tool({
  ...
  inputSchema: zodSchema(z.object({
    ...
    trackingNumber: z
      .string()
      .optional()
      .describe('Carrier tracking number'),
    trackingUrl: z
      .string()
      .optional()
      .describe('Tracking URL for the shipment'),
    company: z
      .string()
      .optional()
...
export const setInventoryTool = tool({
  ...
  inputSchema: zodSchema(z.object({
    ...
    quantity: z
      ...
      .int()
      .min(0)
      .describe('New inventory quantity (0 or more)'),
    locationId: z
      .string()
      .optional()
...
export const createDiscountTool = tool({
  ...
  inputSchema: zodSchema(z.object({
    ...
    code: z
      .string()
      .describe('Discount code customers will enter (e.g. "SUMMER20")'),
    percentage: z
      .number()
      .min(1)
      .max(100)
    ...
    startsAt: z
      .string()
      .optional()
      .describe('Start date ISO string (defaults to now)'),
